...
export const metadata: Metadata = {
  title: 'دسته‌بندی‌های بازی | GameClub Iran',
  description: 'مشاهده تمام دسته‌بندی‌های بازی‌های PS5، اکشن، ماجراجویی، ورزشی و ...',
  openGraph: {
    title: 'دسته‌بندی‌های بازی | GameClub Iran',
    description: 'مشاهده تمام دسته‌بندی‌های بازی‌های PS5، اکشن، ماجراجویی، ورزشی و ...',
    type: 'website',
...
export default async function CategoriesPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'CollectionPage',
    name: 'دسته‌بندی‌های بازی',
    description: 'لیست کامل دسته‌بندی‌های بازی‌های موجود در گیم‌کلاب ایران',
    url: 'https://gameclub-iran.com/categories',
    numberOfItems: categories.length,
    itemListElement: categories.map((cat: any, index: number) => ({
      '@type': 'ListItem',
      position: index + 1,
      name: cat.name,
      url: `https://gameclub-iran.com/categories/${cat.slug}`
    }))
  };
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-slate-600">
            بازی مورد علاقه خود را در دسته‌بندی‌های زیر پیدا کنید
          </p>
        </div>
          ...
          {categories.map((category: any) => (
            ...
            >
              ...
              <p className="mb-4 line-clamp-2 text-sm text-slate-500">
                {category.description || `مجموعه بهترین بازی‌های ${category.name} برای PS5`}
              </p>
              
              <div className="flex items-center justify-between text-sm">
                <span className="rounded-full bg-slate-100 px-3 py-1 font-medium text-slate-600">
                  {category.productCount} بازی
                </span>
