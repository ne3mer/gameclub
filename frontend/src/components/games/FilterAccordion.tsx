    ...
    <div className="w-full border-b border-slate-100 bg-white">
      <div className="mx-auto max-w-[1400px] px-6 md:px-12">
        ...
        <button
          ...
          className="flex w-full items-center justify-between py-6 transition hover:opacity-70"
        >
          <div className="flex items-center gap-4">
            ...
            {activeFiltersCount > 0 && (
              <div className="flex h-6 min-w-6 items-center justify-center rounded-full bg-emerald-500 px-2 text-xs font-bold text-white">
                {activeFiltersCount}
              </div>
            )}
          </div>
