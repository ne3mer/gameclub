            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  placeholder="مثال: بازی‌های اکشن"
                />
              </div>
              <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full rounded-xl border border-slate-200 px-4 py-3 transition focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                  placeholder="بازی اکشن, خرید بازی ps5, ..."
                />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 p-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500">با فعال‌سازی، این دسته در بخش «برای هر نوع گیمر» دیده می‌شود.</p>
                </div>
                <button
                  type="button"
